...
public class MariaDBSetGenerator {
    ...
    private enum Action {
        ...
        /* disabled as a workaround for https://bugs.mariadb.com/bug.php?id=95987 */
        ...
        // RANGE_OPTIMIZER_MAX_MEM_SIZE("range_optimizer_max_mem_size", (r) -> r.getLong(0, Long.MAX_VALUE), Scope.GLOBAL,
                // Scope.SESSION),
        /*
         * Removed Scope.GLOBAL as a workaround for https://bugs.mariadb.com/bug.php?id=95985
         */
        ...
        /*
         * sort_buffer_size is commented out as a workaround for https://bugs.mariadb.com/bug.php?id=95969
         */
        ...
        // TODO: https://dev.mariadb.com/doc/refman/8.0/en/switchable-optimizations.html
        ...
        /*
         * @see https://dev.mariadb.com/doc/refman/8.0/en/switchable-optimizations.html
         */
        private static String getOptimizerSwitchConfiguration(Randomly r) {
            ...
            String[] options = { "condition_pushdown_for_derived", "condition_pushdown_for_subquery", 
                "condition_pushdown_from_having", "default - set all optimizations to their default values.", 
                "derived_merge", "derived_with_keys", "engine_condition_pushdown", "exists_to_in", 
                "extended_keys", "firstmatch", "index_condition_pushdown", "index_merge", 
                ...
                "join_cache_incremental", "loosescan", "materialization", "mrr", "mrr_cost_based", 
                "mrr_sort_keys", "not_null_range_scan", "optimize_join_buffer_size", "orderby_uses_equalities", 
