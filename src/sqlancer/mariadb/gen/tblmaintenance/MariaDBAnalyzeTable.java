...
/**
 * @see <a href="https://dev.mariadb.com/doc/refman/8.0/en/analyze-table.html">ANALYZE TABLE Statement</a>
 */
public class MariaDBAnalyzeTable {

    private final List<MariaDBTable> tables;
    private final StringBuilder sb = new StringBuilder();
    private final Randomly r;

    public MariaDBAnalyzeTable(List<MariaDBTable> tables, Randomly r) {
        this.tables = tables;
        this.r = r;
    }

    public static SQLQueryAdapter analyze(MariaDBGlobalState globalState) {
        return new MariaDBAnalyzeTable(globalState.getSchema().getDatabaseTablesRandomSubsetNotEmpty(),
    ...
    private void dropHistogram() {
        MariaDBTable table = Randomly.fromList(tables);
        sb.append(table.getName());
        // TODO: DROP HISTOGRAM doesn't exist?
