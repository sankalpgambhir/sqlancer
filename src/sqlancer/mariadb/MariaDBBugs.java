...
public final class MariaDBBugs {
    ...
    // https://bugs.mariadb.com/bug.php?id=99127 0.9 > t0.c0 malfunctions when c0 is
    // an INT UNSIGNED
    public static boolean bug99127 = true;

    // https://bugs.mariadb.com/99182 BETWEEN malfunctions for DECIMAL and TEXT
    public static boolean bug99181 = true;

    // https://bugs.mariadb.com/bug.php?id=99183
    public static boolean bug99183 = true;

    // https://bugs.mariadb.com/bug.php?id=95894
    public static boolean bug95894 = true;

    // https://bugs.mariadb.com/bug.php?id=99135
